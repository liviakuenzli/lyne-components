...
export const SbbGrid = /*@__PURE__*/createReactComponent<JSX.SbbGrid, HTMLSbbGridElement>('sbb-grid');
...
export const SbbStack = /*@__PURE__*/createReactComponent<JSX.SbbStack, HTMLSbbStackElement>('sbb-stack');
...
export const SbbTimetableCusHim = /*@__PURE__*/createReactComponent<JSX.SbbTimetableCusHim, HTMLSbbTimetableCusHimElement>('sbb-timetable-cus-him');
...
export const SbbWagonBlockedPassage = /*@__PURE__*/createReactComponent<JSX.SbbWagonBlockedPassage, HTMLSbbWagonBlockedPassageElement>('sbb-wagon-blocked-passage');
